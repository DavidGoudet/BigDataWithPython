...
#Agregamos más iteraciones y hacemos mucho más grande la red
model=MLPClassifier(hidden_layer_sizes=(150,100,100),max_iter=1000)
...
for test in testing:	
	...
	feature = [[int(tweetAnalysis["neg"]*100),int(tweetAnalysis["pos"]*100),int(tweetAnalysis["neu"]*100)]]
